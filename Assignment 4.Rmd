...
If we remove some values, we will lose some of students' data. Probably, our cluster will not as accurate as we expect. 
...
fit <- kmeans(K3b, 2)
K4 <- data.frame(K3b, fit$cluster)

#Have a look at the K4 dataframe. Lets change the names of the variables to make it more convenient with the names() command.
colnames(K4)<- c(1,2,3,4,5,"fit.cluster")
...
K6 <- K5 %>% group_by(week, fit.cluster)%>% summarise(K5, avg = mean(motivation))
...
plot(D3$lat, D3$long, col = D3$fit1.cluster)
