...
names(D5) <- c("accuracy","accuracy_cluster")
ggplot(D5, aes(D1$id, accuracy, col=accuracy_cluster)) + geom_point() + xlab("Student ID") + ylab("Math Accuracy")
```
...
```{r}
ggplot(D5, aes(D1$id, accuracy,col=accuracy_cluster, shape=as.factor(D3$location_cluster))) + 
  geom_point() + 
  xlab("Student ID") + ylab("Math Accuracy")
```
