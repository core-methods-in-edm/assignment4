...
```{r}
D2 <- read.csv('Assistments-confidence.csv')
D2 <- D2[,-5]
...
#I'm going to drop PC7 since it has the least proportion of variance.
## Part II
...
#No, I would not have lost important information about mean_correct.
D4 <- D4[-7]
COR2 <- cor(D4)
