...
- mean_confidence: The average confidence each student has in their ability to answer the problem int he current session
...
#Yes, the correlation we lose may affect mean_correct
COR2 <- cor(D4)
