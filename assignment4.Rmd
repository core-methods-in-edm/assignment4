...
```{r}
D2 <- as.data.frame(select(D1,-mean_correct))
...
The first four components explain 78.87% of the variation of the data. I would consider to drop last two components to make a dicision.
...
tiff("COR2.tiff",units="in",width=5, height=5, res=300)
