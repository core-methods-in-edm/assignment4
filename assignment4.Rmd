...
COR <- cor(D1)
# https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html cheat sheet for corrplot.
corrplot(COR, order="AOE", method="circle", tl.pos="lt", type="upper",        
tl.col="black", tl.cex=0.6, tl.srt=45, 
        addCoef.col="black", addCoefasPercent = TRUE,
        sig.level=0.50, insig = "blank",cl.align="l")
# tl.* for text legend
...
# no, because component 6 can only explain a little variance.
...
# these components convert the originial data into a new space,  maybe some can present study motivation, and some can represent basic knowledge level.
...
dim(humor)
Dh<-humor[,1:36]
Dh<-scale(Dh,center=T)
pcah<-prcomp(Dh,scale=TRUE)
summary(pcah)
