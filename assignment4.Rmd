...
I am likely to drop the last component, confidence since it has the lowest PCA value. 
```{r}
View(D2)
```
...
#Yes, I believe there would be information changed if I drop mean_correct
...
D5 <- read.csv("TCprograms.csv", sep="")
View(D5)
D5 <- D5[,-1]
