...
corrplot(COR2,order = "AOE",method = "circle",tl.pos = "lt",type = "upper",tl.col = "black",
         tl.cex = 0.6,tl.srt = 45,addCoef.col = "black",addCoefasPercent = TRUE,
         sig.level = 0.50,insig = "blank")
...
```{r}
A1 <- read.table("TCprograms.csv",header = TRUE,sep = "")
A2<-A1[,-1]
COR2 <- cor(A2)

corrplot(COR2,order = "AOE",method = "square",tl.pos = "lt",type = "upper",tl.col = "green",tl.cex = 0.1,tl.srt = 20,addCoefasPercent = TRUE,sig.level = 0.50,insig = "blank")
scale(A2,center = TRUE)
