...
```{r}
D1 <- read.csv("~/Desktop/HUDK4050/assignment4/Assistments-confidence.csv")
...
COR_plot <- corrplot(COR, order="AOE", method="circle", tl.pos="lt", type="upper",        
tl.col="black", tl.cex=0.6, tl.srt=45, 
        addCoef.col="black", addCoefasPercent = TRUE,
        sig.level=0.50, insig = "blank")
```
...
R1 <- read.csv("~/Desktop/HUDK4050/assignment4/TCprograms.csv", sep="")


R2 <- dplyr::select(R1, 2:68)
...
R2 <- scale(R2, center = TRUE)

pca2 <- prcomp(R2, scale = TRUE)
