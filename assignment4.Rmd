...
# error: cannpt copy from null device
#print(cor_plot)
#dev.copy(png,'correlogram.png')
#dev.off()
...
I will drop PC5 and PC6, because their variance values are relatively small. 
...
# Compared those two correlograms, we did lose an important correlation between PC6 and mean_correct when dropping PC5 AND PC6.
...
DF_scaled <- scale(DF, center = TRUE)
pca1 <- prcomp(DF_scaled, scale = TRUE)
pca1$sdev
pca1$sdev^2
summary(pca1)
...
sweep(loadings1, 2, colSums(loadings1), "/")
biplot(pca1)
