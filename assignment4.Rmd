...
It depends on what you drop.  PC3 is being compared to the rest of the variables.  Based on the plot PC2, PC1, PC4, PC5, & PC6 are 0 relative to PC3.  I think this means that these variables do not affect PC3.  By dropping one thing you may lose something if you are comparing variables to variables, but if you are using one item and comparing variables I don't think you will lose important information. 
