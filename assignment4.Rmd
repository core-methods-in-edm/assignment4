...
```
```{r}
# Yes, if drop some components will cause losing important infomation about mean_correct.
```
...
# PC1:  the most variance in the three following variables are mean_hint, mean_attempt, and problems_attempted.
# PC2: the most variances are prior_prob_count, prior_percent_correct, and problems_attempted.
# PC3: the most variances are prior_prob_count, problems_attempted, and mean_confidence.
# PC4: the most variances are prior_prob_count and mean_confidence.
# PC5: the most variances are problems_attempted and mean_attempt.
# PC6: the most variance is mean_hint.
