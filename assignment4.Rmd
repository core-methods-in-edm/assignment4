...
```{r}
#I would drop PC6 because five principal components describe at least 90% of the cumulative variance in this dataset. And PC6's proportion of variance accounts for below 0.1. 
```
...
tl.col="black", tl.cex=0.6, tl.srt=45, 
        addCoef.col="black", addCoefasPercent = TRUE,
        sig.level=0.50, insig = "blank")
#I won't lost important information about mean_correct because PC3 and PC5 have little impact on mean_correct (correlations=1).
```
