...
```{r}
f <- file.choose("~/Desktop/hudk4050/Assignment 4/Assistments-confidence.csv")
...
# PC1 explains programs about policy and leadership(like Change Leadership and Educaiton Policy),PC2 explains behavior and health (like Neurosicence and Health Education), PC3 explains quantitative programs (like Math, Learning Analytics)

```{r}
f2 <- file.choose("~/Desktop/hudk4050/Assignment 4/TCprograms.csv")
TC <- read.csv(f2, header = TRUE, sep = "")
TC <- TC[,-1]
