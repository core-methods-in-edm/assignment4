...
* While PC6 had the lowest variances, it does correlate to the variable "mean_correct" with correlation of -0.39. Therefore, meaningful correlations are lost if we remove "mean_correct" from the set of features.
