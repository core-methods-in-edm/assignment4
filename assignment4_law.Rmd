...
Perhaps PC5&6 for the small variance 
...
```{r}
DF-humor <- read.csv("humor_data.csv", header = TRUE)
COR1 <- cor(DF-humor)
corrplot(COR1,method="circle")
DF-humor_scaled <- scale(DF-humor, center = TRUE)
pca1 <- prcomp(DF-humor_scaled, scale = TRUE)
pca1$sdev
pca1$sdev^2
summary(pca1)
